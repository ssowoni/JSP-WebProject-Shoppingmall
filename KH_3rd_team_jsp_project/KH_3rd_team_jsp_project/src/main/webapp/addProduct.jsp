...
<script type="text/javascript" src="./resources/js/addProduct_validation.js"></script>
<meta charset="UTF-8"> 
...
<body>
	...
	<div class="text-right">
		...
		<form name="newProduct" action="/webmarket/admincheck.do" class="form-horizontal" method="post" enctype="multipart/form-data">
