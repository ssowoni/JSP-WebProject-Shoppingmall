	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p><b>상품 코드</b>:<span class="badge-danger"><%=product.getProductId()%></span>
				<p><b>제조사</b> : <%=product.getManufacturer() %>
				<p><b>분류</b> : <%=product.getCategory() %>
				<p><b>재고 수</b> : <%=product.getUnitsInStock() %>
				<h4><%=product.getUnitPrice() %>원</h4>
				<p><form name="addForm" action="../webmarket/addcart.do?productId=<%=product.getProductId()%>" method="post">
